...
static public class BookErrors
{
    ...
    static public readonly Error InvalidTitle = DomainCommonErrors.InvalidProp(ClassName, "Title", "Title", $"It must be between {BookValidationConstants.TitleMinLength} and {BookValidationConstants.TitleMaxLength} characters");
    static public readonly Error PublisherRequired = DomainCommonErrors.RequiredProp(ClassName,"Publisher","Publisher");
    static public readonly Error InvalidPublisher = DomainCommonErrors.InvalidProp(ClassName, "Publisher", "Publisher", $"It must be between {BookValidationConstants.PublisherMinLength} and {BookValidationConstants.PublisherMaxLength} characters");
    static public readonly Error AuthorRequired = DomainCommonErrors.RequiredProp(ClassName,"Author","Author");
    static public readonly Error InvalidAuthor = DomainCommonErrors.InvalidProp(ClassName, "Author", "Author", $"It must be between {BookValidationConstants.AuthorMinLength} and {BookValidationConstants.AuthorMaxLength} characters");
