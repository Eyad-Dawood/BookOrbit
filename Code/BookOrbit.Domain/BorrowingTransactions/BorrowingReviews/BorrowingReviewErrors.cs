...
public class BorrowingReviewErrors
{
    ...
    static public readonly Error InvalidRating = DomainCommonErrors.InvalidProp(ClassName, "Rating", "Rating", $"It must be between {BorrowingReviewValidationConstants.MinRating} and {BorrowingReviewValidationConstants.MaxRating}");
