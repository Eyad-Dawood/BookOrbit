...
public static class RefreshTokenErrors
{
    ...
    static public readonly Error AlreadRevoked = DomainCommonErrors.Custom(ClassName, "TokenAlreadyRevoked", "Token Already Revoked");
    static public readonly Error AlreadyUsed = DomainCommonErrors.Custom(ClassName, "TokenAlreadyUsed", "Token Already Used");
    static public readonly Error CannotUseRevokedToken = DomainCommonErrors.Custom(ClassName, "CannotUseRevokedToken", "Cannot mark a token with [use] while its revoked");
