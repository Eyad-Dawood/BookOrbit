...
static public class BookGeneralValidation
{
    ...
    static public IRuleBuilder<T, string> BookTitleRules<T>(this IRuleBuilder<T, string> ruleBuilder) =>
        ...
        .MinimumLength(BookValidationConstants.TitleMinLength).WithMessage(BookErrors.InvalidTitle.Description)
        .MaximumLength(BookValidationConstants.TitleMaxLength).WithMessage(BookErrors.InvalidTitle.Description);
    ...
    static public IRuleBuilder<T, string> BookISBNRules<T>(this IRuleBuilder<T, string> ruleBuilder) =>
        ...
        .MinimumLength(BookValidationConstants.ISBNMinLength).WithMessage(BookErrors.InvalidISBN.Description)
        .MaximumLength(BookValidationConstants.ISBNMaxLength).WithMessage(BookErrors.InvalidISBN.Description);
    ...
    static public IRuleBuilder<T, string> BookPublisherRules<T>(this IRuleBuilder<T, string> ruleBuilder) =>
        ...
        .MinimumLength(BookValidationConstants.PublisherMinLength).WithMessage(BookErrors.InvalidPublisher.Description)
        .MaximumLength(BookValidationConstants.PublisherMaxLength).WithMessage(BookErrors.InvalidPublisher.Description);
    ...
    static public IRuleBuilder<T, string> BookAuthorRules<T>(this IRuleBuilder<T, string> ruleBuilder) =>
      ...
      .MinimumLength(BookValidationConstants.AuthorMinLength).WithMessage(BookErrors.InvalidAuthor.Description)
      .MaximumLength(BookValidationConstants.AuthorMaxLength).WithMessage(BookErrors.InvalidAuthor.Description);
