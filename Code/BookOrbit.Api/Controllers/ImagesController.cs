    ...
    ISender sender): ApiController
{
    ...
    [ProducesDefaultResponseType]
    [EndpointSummary("Retrieves a book's cover image.")]
    [EndpointDescription("Returns the book's cover image by book Id. If the image is not found, a default image is returned.")]
    [MapToApiVersion("1.0")]
